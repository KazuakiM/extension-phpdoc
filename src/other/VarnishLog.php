...
class VarnishLog
{
     ...
     *
     * @see http://php.net/manual/en/varnishlog.construct.php
     */
     ...
     * @return array
     *
     * @see http://php.net/manual/en/varnishlog.getline.php
     */
     ...
     * @return string
     *
     * @see http://php.net/manual/en/varnishlog.gettagname.php
     */

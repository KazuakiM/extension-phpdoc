 ...
 *
 * @see http://php.net/manual/en/class.solrgenericresponse.php
 */
final class SolrGenericResponse extends SolrResponse
{
     ...
     * Constructor.
     *
     * @see http://php.net/manual/en/solrgenericresponse.construct.php
     */
     ...
     * Destructor.
     *
     * @see http://php.net/manual/en/solrgenericresponse.destruct.php
     */
